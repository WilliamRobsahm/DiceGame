...
function preloadImages() {
    images = {
        ...
        encounter1:image("assets/img/encounter1.png"),
        encounter2:image("assets/img/encounter2.png"),
        encounter3:image("assets/img/encounter3.png"),
        boss:image("assets/img/boss.png"),
